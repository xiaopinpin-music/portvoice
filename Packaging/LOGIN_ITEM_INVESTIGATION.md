...
- the menu bar appears in the menu bar.
...
Connect login/startup behavior to launch PortVoice in background mode so that macOS login starts the menu bar and monitoring without opening the dashboard.
